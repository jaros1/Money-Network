        ...
        function z_update_6_like_json (publish) {
            ...
            get_like_json(function (like, like_index, empty) {
                ...
                var error, index, i, contact, j, message_with_envelope, k, like_updated, auth_address,
                    ...
                    this_reaction_updated, like_index_p, like_index_a, unique_id, old_reaction ;
                ...
                for (i=0 ; i<ls_contacts.length ; i++) {
                    ...
                    for (j=0 ; j<contact.messages.length ; j++) {
                        ...
                        if (like_index.hasOwnProperty(like_index_p)) {
                            ...
                            debug('reaction', pgm + 'index_p: ' + like_index_p + ': added new public emoji reaction ' + message_with_envelope.reaction + ' to like.json') ;
                ...
                for (reactions_index in ls_reactions) {
                    ...
                    for (emoji in compare) {
                        ...
                        if (!refresh_reactions[refresh_key]) {
                            ...
                            if (!refresh_reactions[refresh_key]) debug('reaction', pgm + 'cannot find any outbox message with sent_at timestamp ' + reactions_index) ;
                        }
                ...
                if (decrypted_message.reaction && !is_emoji[decrypted_message.reaction]) {
                    ...
                    (function() {
                        var obj_of_reaction, i, group_chat_contact, j, message, old_reaction, new_reaction,
                            reaction_info, old_private_group_reaction, new_private_group_reaction, send_msg,
                        ...
                        send_msg = function (reaction) {
                            ...
                            message = {
                                msgtype: 'reaction',
                                timestamp: decrypted_message.timestamp,
                                reaction: reaction,
                                count: count,
                            ...
                            if (error) {
                                ...
                                add_msg(group_chat_contact, message);
                                no_msg++ ;
                            }
                        } ; // send_msg
                        if (old_reaction == new_reaction) {
