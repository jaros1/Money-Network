angular.module('MoneyNetwork')
    ...
    .factory('MoneyNetworkService', ['$timeout', '$rootScope', '$window', '$location', 'dateFilter', 'MoneyNetworkHubService', 'MoneyNetworkEmojiService',
                             function($timeout, $rootScope, $window, $location, date, moneyNetworkHubService, moneyNetworkEmojiService)
    {
        ...
        var emoji_folders = get_emoji_folders() ;
        ...
        //    var emoji_folder = z_cache.user_setup.emoji_folder || emoji_folders[0] ; // current emoji folder
        ...
        function unicode_to_symbol (unicode) {
            return moneyNetworkEmojiService.unicode_to_symbol(unicode);
        }
        //function unicode_to_symbol (unicode) {
        ...
        function replace_emojis (str) {
            return moneyNetworkEmojiService.replace_emojis(str);
        }
        //function replace_emojis (str) {
        ...
        function get_reaction_list (full_emoji_support) {
            return moneyNetworkEmojiService.get_reaction_list (full_emoji_support);
        }
        //function get_reaction_list (full_emoji_support) {
